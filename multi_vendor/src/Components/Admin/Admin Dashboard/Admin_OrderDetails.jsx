...
//                         <h2 className="text-2xl font-semibold">{orderDetails.title}</h2>
//                         <p className="text-gray-600">{orderDetails.description}</p>
//                         <p><strong>Order ID:</strong> {orderDetails.id}</p>
//                         <p><strong>Order Placed:</strong> {orderDetails.orderPlacedDate}</p>
//                         <div>
...
//                             <p>{orderDetails.deliveryAddress.country}, {orderDetails.deliveryAddress.zipCode}</p>
//                         </div>
//                         <p><strong>Total Amount:</strong> US$ {orderDetails.total}</p>
//                         <div className="flex items-center space-x-4">
//                             <label htmlFor="status" className="font-semibold">Status:</label>
//                             <select
//                                 id="status"
