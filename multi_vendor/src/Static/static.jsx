...
export const sideItems = [
    { icon: FiLayout, label: 'Dashboard', href: '/Shop/dashboard' },
    { icon: FiShoppingBag, label: 'All Orders', href: '/Shop/orders' },
    { icon: FiPackage, label: 'All Products', href: '/Shop/products' },
    { icon: FiFilePlus, label: 'Create Product', href: '/Shop/create-product' },
    { icon: FiTag, label: 'All Events', href: '/Shop/events' },
    { icon: FiPlusCircle, label: 'Create Event', href: '/Shop/create-event' },
    { icon: FiDollarSign, label: 'Withdraw Money', href: '/Shop/withdraw' },
    { icon: FiMessageSquare, label: 'Shop Inbox', href: '/Shop/inbox' },
    { icon: FiGift, label: 'Discount Codes', href: '/Shop/discounts' },
    { icon: FiRefreshCw, label: 'Refunds', href: '/Shop/refunds' },
...
export const menuItems = [
    { id: 1, label: "Profile", icon: <RxPerson size={20} />, path: "/dashboard/profile" },
    { id: 2, label: "Orders", icon: <HiOutlineShoppingBag size={20} />, path: "/dashboard/orders" },
    { id: 3, label: "Refunds", icon: <HiOutlineReceiptRefund size={20} />, path: "/dashboard/refunds" },
    { id: 4, label: "Inbox", icon: <AiOutlineMessage size={20} />, path: "/dashboard/inbox" },
    { id: 5, label: "Track Order", icon: <MdOutlineTrackChanges size={20} />, path: "/dashboard/track-order" },
    { id: 6, label: "Payment Method", icon: <BsCreditCard2Back size={20} />, path: "/dashboard/payment-method" },
    { id: 7, label: "Address", icon: <TbAddressBook size={20} />, path: "/dashboard/address" },
    { id: 8, label: "Log Out", icon: <AiOutlineLogin size={20} />, path: "/dashboard/logout" },
];
