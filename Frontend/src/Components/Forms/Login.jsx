...
const Login = ({ handleSumbit, data, loading, handleChange, isUser }) => {
                    ...
                    <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
                        <form className="space-y-6">
                            <div>
                                ...
                                >
                                    {isUser ? "Email address or UserName" : "Email address"}
                                </label>
                                <div className="mt-1">
                                    <input
                                        type="email"
                            ...
                            <div className={`${styles.noramlFlex} w-full`}>
                                ...
                                {isUser ? (
                                    ...
                                    <Link to="/register-shop" className="text-blue-600 pl-2">
                                        Register Shop
                                    </Link>
                                )}
                            </div>
