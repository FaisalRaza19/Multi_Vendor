...
const adminRegisterShop = () => {
    const {showAlert} = useContext(ContextApi)
    const { registerShop } = useContext(ContextApi).adminAuth;
    ...
    const handleSubmit = async (e) => {
        ...
        setIsLoading(true)
        try {
            const data = await registerShop({ formData,navigate});
            showAlert(data);
        } catch (error) {
...
export default adminRegisterShop;
